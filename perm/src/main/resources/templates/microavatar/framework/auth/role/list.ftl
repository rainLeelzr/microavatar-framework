...
<body>
  <form id="form1" method="post">
    <div style="width:100%;">
      <div class="mini-toolbar" style="border-bottom:0;padding:0px;">
        <table style="width:100%;">
          <tr>
            <td style="white-space:nowrap;">              <input class="mini-textbox" id="name" name="name" emptyText="请输入角色名" style="width:150px;" onenter="onKeyEnter()"/>              <a class="mini-button" onclick="search()">查询</a>
            </td>
          </tr>
          <tr>
            <td style="width:100%;">
    ...
    <div class="mini-datagrid" id="datagrid1" style="width:100%;height:400px;" url="/auth/role!query.action" idField="id" allowResize="true" multiSelect="true">
