...
public class TcpPacket {
    ...
    public static TcpPacket buildProtoPackage(MethodEnum methodEnum, String url, byte[] body) {
        return buildPackage(methodEnum, url, SerializationMode.PROTOBUF2, body);
    }

    public static TcpPacket buildProtoPackage(byte method, String url, byte[] body) {
        return buildPackage(method, url, SerializationMode.PROTOBUF2, body);
    }
    ...
    public static TcpPacket buildJsonPackage(MethodEnum methodEnum, String url, byte[] body) {
        return buildPackage(methodEnum, url, SerializationMode.JSON, body);
    }

    public static TcpPacket buildJsonPackage(byte method, String url, byte[] body) {
        return buildPackage(method, url, SerializationMode.JSON, body);
    }
     ...
     *
     * @param url  url
     * @param mode body数据的序列化模式
     * @param body body数据
     */
    public static TcpPacket buildPackage(MethodEnum methodEnum, String url, SerializationMode mode, byte[] body) {
        return buildPackage(methodEnum.id, url, mode, body);
    }

    public static TcpPacket buildPackage(byte method, String url, SerializationMode mode, byte[] body) {
        byte[] urlBytes;
        try {
        ...
        return new TcpPacket(length, method, urlBytes.length, urlBytes, mode.geId(), body);
    }
