...
<body>    
    <form id="form1" method="post">
      <div style="padding-left:11px;padding-bottom:5px;">        <input name="id" id="id" class="mini-hidden" required="false"/>    
        ...
        <table style="table-layout:fixed;" class="table2">          <tr>
            ...
            <td class="tdcontent">              <input class="mini-textbox" id="realName" name="realName" emptyText="请输入真实名称" vtype="maxLength:16" required="true" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">性别：</td>
            <td class="tdcontent">              <input class="mini-datepicker" id="gender" name="gender" emptyText="请输入性别" required="true"/>            </td>
          </tr>          <tr>
            <td class="tdtitle">qq：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="qq" name="qq" emptyText="请输入qq" vtype="maxLength:16" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">固话：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="telephone" name="telephone" emptyText="请输入固话" vtype="maxLength:16" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">手机号码：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="mobilePhone" name="mobilePhone" emptyText="请输入手机号码" vtype="maxLength:16" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">电子邮件：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="email" name="email" emptyText="请输入电子邮件" vtype="maxLength:32" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">生日：</td>
            <td class="tdcontent">              <input class="mini-datepicker" id="birthday" name="birthday" emptyText="请输入生日" required="false"/>            </td>
          </tr>          <tr>
    ...
    <script type="text/javascript">
      ...
      function openUpload(){
        mini.open({
          url : "/base/attachment!uploadPage.action?bizCode=userInfo",
          title : "上传附件",
          width : 1000,
          height : 600,
          onload : function() {
      ...
      function onUniqueValidate(e){
        if (e.isValid) {
          $.ajax({
            url:"/auth/userInfo!validateUnique.action",
            type:"post",
            data: {
