...
<body>    
    <form id="form1" method="post">
      <div style="padding-left:11px;padding-bottom:5px;">        <input name="id" id="id" class="mini-hidden" required="false"/>    
        ...
        <table style="table-layout:fixed;" class="table2">          <tr>
            ...
            <td class="tdcontent">              <input class="mini-textbox" id="type" name="type" emptyText="请输入类型" vtype="maxLength:0" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">域名或ip：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="host" name="host" emptyText="请输入域名或ip" vtype="maxLength:64" required="true" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">路径：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="url" name="url" emptyText="请输入路径" vtype="maxLength:256" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
    ...
    <script type="text/javascript">
      ...
      function SaveData() {
        ...
        $.ajax({
          url: "/auth/sysResource!save.action",
          type: 'post',
          data: { 
      ...
      function SetData(data) {
        ...
        if (data.action == "edit" || data.action == "view") {
          $.ajax({
            url: "/auth/sysResource!get.action",
            type:"post",
            data:{
              id:data.id
            },
      ...
      function openUpload(){
        mini.open({
          url : "/base/attachment!uploadPage.action?bizCode=sysResource",
          title : "上传附件",
          width : 1000,
          height : 600,
          onload : function() {
      ...
      function onUniqueValidate(e){
        if (e.isValid) {
          $.ajax({
            url:"/auth/sysResource!validateUnique.action",
            type:"post",
            data: {
