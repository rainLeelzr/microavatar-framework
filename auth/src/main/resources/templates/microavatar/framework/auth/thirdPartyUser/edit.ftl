...
<body>    
    <form id="form1" method="post">
      <div style="padding-left:11px;padding-bottom:5px;">        <input name="id" id="id" class="mini-hidden" required="false"/>    
        ...
        <table style="table-layout:fixed;" class="table2">          <tr>
            ...
            <td class="tdtitle">接入时间：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="accessTime" name="accessTime" emptyText="请输入接入时间" vtype="maxLength:0" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">唯一标识：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="uniqueId" name="uniqueId" emptyText="请输入唯一标识" vtype="maxLength:64" required="true" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>        </table>
    ...
    <script type="text/javascript">
      ...
      function SaveData() {
        ...
        $.ajax({
          url: "/auth/thirdPartyUser!save.action",
          type: 'post',
          data: { 
      ...
      function SetData(data) {
        ...
        if (data.action == "edit" || data.action == "view") {
          $.ajax({
            url: "/auth/thirdPartyUser!get.action",
            type:"post",
            data:{
              id:data.id
            },
      ...
      function openUpload(){
        mini.open({
          url : "/base/attachment!uploadPage.action?bizCode=thirdPartyUser",
          title : "上传附件",
          width : 1000,
          height : 600,
          onload : function() {
      ...
      function onUniqueValidate(e){
        if (e.isValid) {
          $.ajax({
            url:"/auth/thirdPartyUser!validateUnique.action",
            type:"post",
            data: {
