...
<body>    
    <form id="form1" method="post">
      <div style="padding-left:11px;padding-bottom:5px;">        <input name="id" id="id" class="mini-hidden" required="false"/>    
        ...
        <table style="table-layout:fixed;" class="table2">          <tr>
            ...
            <td class="tdcontent">              <input class="mini-textbox" id="parentId" name="parentId" emptyText="请输入父id" vtype="maxLength:36" required="true" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">名称：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="name" name="name" emptyText="请输入名称" vtype="maxLength:64" required="true" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">简称：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="abbreviation" name="abbreviation" emptyText="请输入简称" vtype="maxLength:64" required="true" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">地址：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="address" name="address" emptyText="请输入地址" vtype="maxLength:256" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">联系方式：</td>
            <td class="tdcontent">              <textarea class="mini-textarea" id="contact" name="contact" style="width:350px;" emptyText="请输入联系方式"></textarea>            </td>
          </tr>          <tr>
            ...
            <td class="tdtitle">创建者：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="createdUserId" name="createdUserId" emptyText="请输入创建者" vtype="maxLength:36" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">启用：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="enabled" name="enabled" emptyText="请输入启用" vtype="maxLength:0" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">备注：</td>
            <td class="tdcontent">              <textarea class="mini-textarea" id="remark" name="remark" style="width:350px;" emptyText="请输入备注"></textarea>            </td>
          </tr>        </table>
    ...
    <script type="text/javascript">
      ...
      function openUpload(){
        mini.open({
          url : "/base/attachment!uploadPage.action?bizCode=org",
          title : "上传附件",
          width : 1000,
          height : 600,
          onload : function() {
      ...
      function onUniqueValidate(e){
        if (e.isValid) {
          $.ajax({
            url:"/auth/org!validateUnique.action",
            type:"post",
            data: {
