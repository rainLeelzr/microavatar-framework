...
<body>
  <form id="form1" method="post">
    ...
    <div class="mini-datagrid" id="datagrid1" style="width:100%;height:400px;" url="/base/errorInfo!query.action" idField="id" allowResize="true" multiSelect="true">
  ...
  <script type="text/javascript">
    ...
    */
    function add() {
      mini.open({
        url: "/base/errorInfo!edit.action",
        title: "新增错误信息",
        width: 1000,
        height: 600,
        onload: function() {
    ...
    function remove() {
      ...
      if (rows.length > 0) {
        if (confirm("确定删除选中记录？")) {
          ...
          $.ajax({
            url: "/base/errorInfo!delete.action",
            type: 'post',
            data: {
              id: id
            },
