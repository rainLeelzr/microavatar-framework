...
<body>    
    <form id="form1" method="post">
      <div style="padding-left:11px;padding-bottom:5px;">        <input name="id" id="id" class="mini-hidden" required="false"/>    
        ...
        <table style="table-layout:fixed;" class="table2">          <tr>
            ...
            <td class="tdcontent">              <input class="mini-textbox" id="name" name="name" emptyText="请输入名称" vtype="maxLength:32" required="true" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">类型：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="type" name="type" emptyText="请输入类型" vtype="maxLength:0" required="true" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">key：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="keyStr" name="keyStr" emptyText="请输入key" vtype="maxLength:64" required="true" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">value：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="valueStr" name="valueStr" emptyText="请输入value" vtype="maxLength:256" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
            <td class="tdtitle">值的格式：</td>
            <td class="tdcontent">              <input class="mini-textbox" id="valueType" name="valueType" emptyText="请输入值的格式" vtype="maxLength:0" required="false" .if(false)onvalidation="onUniqueValidate".endif/>            </td>
          </tr>          <tr>
    ...
    <script type="text/javascript">
      ...
      function openUpload(){
        mini.open({
          url : "/base/attachment!uploadPage.action?bizCode=param",
          title : "上传附件",
          width : 1000,
          height : 600,
          onload : function() {
      ...
      function onUniqueValidate(e){
        if (e.isValid) {
          $.ajax({
            url:"/base/param!validateUnique.action",
            type:"post",
            data: {
